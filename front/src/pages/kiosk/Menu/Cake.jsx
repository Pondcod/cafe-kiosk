...
const Cake = () => {
  ...
  // 1) Filter items whose subCategory includes "Cake"
  const cakeMenus = Menu.filter(
    item =>
      Array.isArray(item.subCategory) &&
      item.subCategory.includes('Cake')
  );
  const displayMenus = cakeMenus;
    ...
    >
      ...
      <div className="flex flex-col flex-1 h-screen overflow-hidden">
        <div className="flex-1 flex flex-col p-6 overflow-y-auto mr-10">
          <h1 className="text-5xl font-medium mb-6">Cake</h1>
