...
function MenuPage(){
  ...
  return (
    <div className='h-screen flex flex-col' style={{backgroundColor: ColorPalette.beige_cus_2}}>
      <img src={logo} alt="Logo" className="w-55 h-55 mx-auto hover:scale-115 opacity-90" />
      <div className="mt-4">
        <div className="w-[calc(100%-2rem)] h-70 mx-auto rounded-3xl overflow-hidden shadow-xl">
          <Slider {...settings}>
            <div>
      ...
      <p className="text-5xl pt-[2rem] pl-[2.5rem]">Explore our menu</p>
      <div className="grid grid-cols-3 gap-y-12 gap-x-6 place-items-center mt-13 px-15 pb-21">
        <div className="flex flex-col items-center">
          <button
            onClick={() => navigate('/Menu/Coffee')}
            type="button"
            className="border-none p-10 rounded-4xl shadow-xl outline-hidden"
            style={{ backgroundColor: ColorPalette.beige_cus_1, borderColor: '#000' }}
          >
            <BiSolidCoffeeBean className="text-[5rem] text-black" />
          </button>
          <h1 className="text-3xl mt-5 text-center">Coffee</h1>
        </div>
        <div className="flex flex-col items-center">
          <button
          ...
          <h1 className="text-3xl mt-5 text-center">Tea</h1>
        </div>
        <div className="flex flex-col items-center">
          <button
          ...
          <h1 className="text-3xl mt-5 text-center">Milk</h1>
        </div>
        <div className="flex flex-col items-center">
          <button
          ...
          <h1 className="text-3xl mt-5 text-center">Others</h1>
        </div>
        <div className="flex flex-col items-center">
          <button
          ...
          <h1 className="text-3xl mt-5 text-center">Bakery</h1>
        </div>
        <div className="flex flex-col items-center">
          <button
            ...
            style={{ backgroundColor: ColorPalette.beige_cus_1, borderColor: '#000' }}
          >
            <LuCakeSlice  className="text-[5rem] text-black" />
          </button>
          <h1 className="text-3xl mt-5 text-center">Cake</h1>
        </div>
      </div>
      <div
