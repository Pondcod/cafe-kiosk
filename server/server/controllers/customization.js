...
const getCustomizationById = async (req, res) => {
  try {
    ...
    const products = productData ? productData.map(item => item.products) : [];
...
const getCustomizationsByType = async (req, res) => {
  try {
    ...
    console.log(`Retrieved ${data ? data.length : 0} customizations of type ${type}`);
    res.json({ success: true, data });
  } catch (error) {
...
const getCustomizationsByProduct = async (req, res) => {
  try {
    ...
    if (error) {
      console.error('Supabase error fetching customizations for product:', error);
      throw error;
    }
...
const createCustomization = async (req, res) => {
  try {
    ...
    console.log('Creating customization with data:', { name, price_adjustment, customization_type });
...
const updateCustomization = async (req, res) => {
  try {
    const { id } = req.params;
    const { name, price_adjustment, customization_type, active_status } = req.body;
    console.log(`Updating customization ${id} with data:`, { name, price_adjustment, customization_type, active_status });
    ...
    if (customization_type !== undefined) updateData.customization_type = customization_type;
...
const addCustomizationToProduct = async (req, res) => {
  try {
    ...
    console.log(`Adding customization ${customization_id} to product ${product_id}`);
...
const removeCustomizationFromProduct = async (req, res) => {
  try {
    ...
    console.log(`Removing customization ${customization_id} from product ${product_id}`);
    ...
    if (error) {
      console.error('Supabase error removing customization from product:', error);
      throw error;
    }
